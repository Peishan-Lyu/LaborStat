...
Demographics might not be the hottest buzzword today in Economics or Sociology, but has always been an area of great significance, due to the humongous influence that it exerts to human societies over the long horizon, both in the past and in the future.
...
1. Highlight the current situation of world demographics, and the historical trends of the past decades, by region and country.
