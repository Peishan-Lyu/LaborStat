...
Q7_fields = c(''SP.POP.TOTL.FE.ZS', 'SP.POP.1519.FE.5Y', 'SP.POP.2024.FE.5Y', 'SP.POP.2529.FE.5Y', 'SP.POP.3034.FE.5Y', 'SP.POP.3539.FE.5Y', 'SP.POP.4044.FE.5Y', 'SP.POP.4549.FE.5Y')

BirthRate_Demo_Country <- Stats_by_Country_1972_2021 %>%
  filter(SeC %in% Q7_fields) %>%
  select(c('SeC', 'SeN', 'CoN', '1980', '2020')) %>%
  pivot_longer(cols = !c('SeC', 'SeN', 'CoN'), names_to = 'Year', values_to = 'Percent')
